...
public class Login extends javax.swing.JFrame {
    ...
    public void verificar() {
        ...
        String passwordChars = txtPass.getPassword();
        ...
        if (!user.isEmpty() && !pass.isEmpty()) {
            try {
                ...
                if (us.next()) {
                    String storedPassword = us.getString("password");
                    if (pass.equals(storedPassword)) {
                        // La verificación es exitosa, puedes realizar acciones adicionales aquí
                        JOptionPane.showMessageDialog(this, "Inicio de sesión exitoso");

                        // Puedes redirigir a otra ventana o realizar otras acciones después del inicio de sesión
    ...
    private void initComponents() {
        ...
        bg.setBackground(new java.awt.Color(255, 215, 0));  // Establece el color dorado como fondo del login

        ImageIcon iconoOriginal = new ImageIcon(getClass().getResource("/images/Royal.png"));
        Image imagenOriginal = iconoOriginal.getImage();

        int nuevaAnchura = 250;
        int nuevaAltura = 280;
        int yOffset = 50; // Ajusta este valor para mover verticalmente

        Image nuevaImagen = imagenOriginal.getScaledInstance(nuevaAnchura, nuevaAltura, java.awt.Image.SCALE_SMOOTH);

// Crea un nuevo ImageIcon con la imagen ajustada
        ImageIcon iconoAjustado = new ImageIcon(nuevaImagen);

// Crea el JLabel y configura el texto "ROYAL CAFE"
        logoname.setBackground(new java.awt.Color(255, 255, 255));
        logoname.setFont(new java.awt.Font("Roboto Medium", 0, 24));
        logoname.setForeground(new java.awt.Color(255, 215, 0)); // Establece el color dorado
        logoname.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logoname.setText("");
// Ajusta las coordenadas para mover verticalmente
        bg.add(logoname, new org.netbeans.lib.awtextra.AbsoluteConstraints(554, 250 + yOffset, 290, 20));

// Crea el JLabel y configura la imagen ajustada
        JLabel logo = new JLabel();
        logo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logo.setIcon(iconoAjustado);
        bg.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 90, nuevaAnchura, nuevaAltura));


        //citybg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/images/city.png"))); // NOI18N
        ...
        favicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/expres.png"))); // NOI18N
        favicon.setText("Tal y Como Te Gusta");
        favicon.setForeground(new java.awt.Color(50, 210, 1)); // Color dorado (255, 215, 0 es el código RGB para el dorado)
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        String password = String.valueOf(passTxt.getPassword()).trim();

        // Verifica que el usuario sea "admin" y la contraseña sea "admin"
    ...
    private static class Session {
        ...
        private ResultSet listar(String string) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    }
}
